...
export default function Btn09({ text, className }: TextProps) {
  return (
    <Button
      className={cn(
        "group relative inline-flex items-center justify-center overflow-hidden rounded-md bg-gray-800 px-8 py-4 tracking-tighter text-white",
        className
      )}
    >
