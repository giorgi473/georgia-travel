        ...
        <div className="w-full relative">
          ...
          >
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "აფხაზეთი" ? "red" : "#eeebf3"}
              strokeLinecap="round"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "რაჭა" ? "red" : "#ffffff"}
              strokeLinecap="round"
              strokeLinejoin="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "იმერეთი" ? "red" : "#ffffff"}
              strokeLinecap="round"
              strokeLinejoin="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "სამაჩაბლო" ? "red" : "#eeebf3"}
              strokeLinecap="round"
              strokeLinejoin="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "გურია" ? "red" : "#ffffff"}
              strokeLinecap="round"
              strokeLinejoin="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "აჭარა" ? "red" : "#eeebf3"}
              strokeLinecap="round"
              strokeLinejoin="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "სამცხე-ჯავახეთი" ? "red" : "#ffffff"}
              strokeLinecap="round"
              strokeLinejoin="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "ქვემო ქართლი" ? "red" : "#ffffff"}
              strokeLinecap="round"
              strokeLinejoin="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "შიდა ქართლი" ? "red" : "#ffffff"}
              strokeLinejoin="round"
              strokeLinecap="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={
                activeRegion === "სამეგრელო-ზემო სვანეთი" ? "red" : "#ffffff"
              }
              strokeLinejoin="round"
              strokeLinecap="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "მცხეთა-მთიანეთი" ? "red" : "#ffffff"}
              strokeLinecap="round"
              strokeLinejoin="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "კახეთი" ? "red" : "#eeebf3"}
              strokeLinejoin="round"
              strokeLinecap="round"
              className="cursor-pointer hover:fill-red-500"
            ...
            <path
              ...
              stroke="#b7b7b7"
              fill={activeRegion === "თბილისი" ? "red" : "#eeebf3"}
              strokeLinejoin="round"
              strokeLinecap="round"
              className="cursor-pointer hover:fill-red-500"
