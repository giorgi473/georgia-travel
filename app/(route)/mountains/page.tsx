...
import { cardsData, contentItems, sidebarItems } from "@/constants/get/data";
import ParagraphText from "./_components/paragraph-text";

const Page: React.FC = () => {
  const router = useRouter();
  const section01 = cardsData.find((section) => section.id === 1);
        ...
        {geographyItem && (
          <div className="relative w-full h-full">
            ...
            <div className="absolute top-0 left-0 lg:left-44 h-full flex flex-col justify-center p-4 sm:p-6 text-white">
              <motion.h1
                className="text-3xl max-w-lg sm:text-4xl font-bold mb-4"
                initial="hidden"
                animate="visible"
