...
import { componentAttributes } from "@/constants/data/sightsData";
...
function ArtsCulturePage() {
  ...
  return (
    <div className="space-y-24">
      <section>
        <ImageContent {...componentAttributes[3].mainSection} />
      </section>
      <section>
        <DescriptionText {...componentAttributes[3].descriptionText} />
      </section>
      <section className="container mx-auto px-5 sm:px-8 md:px-8 lg:px-11 py-8">
        <ExploreSnapCard {...componentAttributes[3].exploreSnapCard} />
      </section>
      <section>
        <CardSwiperSlider />
      </section>
