...
function ArtsCulturePage() {
  ...
  return (
    <div className="space-y-24">
      <section>
        <ImageContent {...componentAttributes[4].mainSection} />
      </section>
      <section>
        <DescriptionText {...componentAttributes[4].descriptionText} />
      </section>
      <section className="container mx-auto px-5 sm:px-8 md:px-8 lg:px-11 py-8">
        <ExploreSnapCard {...componentAttributes[4].exploreSnapCard} />
      </section>
      <section>
        <CardSwiperSlider />
      </section>
