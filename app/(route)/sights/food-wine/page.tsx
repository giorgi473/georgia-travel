...
function ArtsCulturePage() {
  ...
  return (
    <div className="space-y-24">
      <section>
        <ImageContent {...componentAttributes[2].mainSection} />
      </section>
      <section>
        <DescriptionText {...componentAttributes[2].descriptionText} />
      </section>
      <section className="container mx-auto px-5 sm:px-8 md:px-8 lg:px-11 py-8">
        <ExploreSnapCard {...componentAttributes[2].exploreSnapCard} />
      </section>
      <section>
        <CardSwiperSlider />
      </section>
